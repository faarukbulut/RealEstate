...
namespace RealEstate_UI.Areas.EstateAgent.ViewComponents.EstateAgentPage
{
    public class _EstateAgentDashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync($"https://localhost:44367/api/Statistics/ProductCountByEmployeeId/{userID}");
            ...
            var responseMessage3 = await client3.GetAsync($"https://localhost:44367/api/Statistics/ProductCountByStatusTrue/{userID}");
            ...
            var responseMessage4 = await client4.GetAsync($"https://localhost:44367/api/Statistics/ProductCountByStatusFalse/{userID}");
