...
namespace RealEstate_UI.Areas.EstateAgent.ViewComponents.EstateAgentPage
{
    public class _EstateAgentDashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync(ApiSettings.BaseUrl + $"Statistics/ProductCountByEmployeeId/{userID}");
            ...
            var responseMessage3 = await client3.GetAsync(ApiSettings.BaseUrl + $"Statistics/ProductCountByStatusTrue/{userID}");
            ...
            var responseMessage4 = await client4.GetAsync(ApiSettings.BaseUrl + $"Statistics/ProductCountByStatusFalse/{userID}");
