...
namespace RealEstate_UI.Areas.EstateAdmin.ViewComponents.AdminPage
{
    public class _AdminDashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:7287/api/Statistics/EmployeeNameByMaxProductCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:7287/api/Statistics/DifferentCityCount");
